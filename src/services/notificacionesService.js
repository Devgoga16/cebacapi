 ...
 */
exports.crearNotificacion = async ({ id_usuario, tipo, referencia_id = null, tipo_entidad = null, id_aula = null, titulo, mensaje }) => {
  return await Notificacion.create({ id_usuario, tipo, referencia_id, tipo_entidad, id_aula, titulo, mensaje });
};

/**
 * Crea una notificación para cada usuario de la lista (inserción masiva).
 * @param {string[]} idsUsuarios
 * @param {{ tipo: string, referencia_id?: string, tipo_entidad?: string, id_aula?: string, titulo: string, mensaje: string }} datosComunes
 */
exports.crearNotificacionesMasivas = async (idsUsuarios, { tipo, referencia_id = null, tipo_entidad = null, id_aula = null, titulo, mensaje }) => {
